	    ...
	    var link=    $(`<div class="option">
	    					...
	    					<div class="option-switcher-btn icon-option"><i class="fa fa-gear"></i></div>
								...
								<div class="option-swticher-body">
									...
									<a href="http://bit.ly/WB-Listty" class="btn-purchase"><i class="fa fa-shopping-cart"></i> Buy This Theme</a>
...
var setColor = function (color) {
	...
	jQuery('.fixed-header').click(function(){
		...
		jQuery('nav').removeClass('navbar-scrollUp');
	});
	jQuery('.scrollUp-header').click(function(){
		...
		jQuery('nav').addClass('navbar-scrollUp');
	});

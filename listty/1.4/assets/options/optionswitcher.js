...
//LTR and RTL
var leftToRight = jQuery('.left-to-right');
var rightToLeft = jQuery('.right-to-left');

jQuery('.left-to-right').click(function(){
	leftToRight.addClass("tho-active-switcher-btn");
	rightToLeft.removeClass("tho-active-switcher-btn");
	jQuery('#bootstrap-rtl').attr("href", "");
	jQuery('#rtl_css').attr("href", "");
	jQuery("body").removeClass("rtl");
});
jQuery('.right-to-left').click(function(){
	rightToLeft.addClass("tho-active-switcher-btn");
	leftToRight.removeClass("tho-active-switcher-btn");
	jQuery('#bootstrap-rtl').attr("href",

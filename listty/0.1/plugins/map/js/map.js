...
function initialize() {
  ...
  function getMarkerContent(creature){
    var content=' <div class="flip-container">'+
                    '<div class="flipper">'+
                        '<div class="front">'+
                            '<img src="images/marker-front.png">'+
                        '</div>'+
                        '<div class="back">'+
                           '<img src="images/marker-back.png">'+
                        '</div>'+
                    '</div>'+
                '</div>';
    return content;             
   ...
   function addMarker(creature){
      ...
      google.maps.event.addListener(infowindow, 'domready', function() {
        ...
        */
        ...
        iwCloseBtn.css({opacity: '1', right: '40px', top: '3px', border: '7px solid #ffffff', 'border-radius': '13px', 'box-shadow': '0 0 5px rgba(0, 0, 0, .2)'});

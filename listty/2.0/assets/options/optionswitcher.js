				...
				<div class="tho-option-switcher-btn tho-icon-option">
					...
					<div class="tho-option-swticher-body">
						...
						<ul class="tho-list-unstyled tho-color-options">
							<li class="theme-default theme-active" data-color="listty" data-logo="default-logo"></li>
							<li class="theme-color1" data-color="listty-color1" data-logo="logo1"></li>
							<li class="theme-color2" data-color="listty-color2" data-logo="logo2"></li>
							<li class="theme-color3" data-color="listty-color3" data-logo="logo3"></li>
							<li class="theme-color4" data-color="listty-color4" data-logo="logo4"></li>
						</ul>
...
ltr.click(function() {
	...
	jQuery("#option_style").attr("href", "assets/css/listty.css");
...
rtl.click(function() {
  ...
  jQuery("#option_style").attr("href", "assets/css/listty.rtl.css");
});

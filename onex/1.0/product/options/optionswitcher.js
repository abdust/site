	    ...
	    var link=    $(`<div class="option">
	    					...
	    					<div class="option-switcher-btn icon-option"><i class="fa fa-gear"></i></div>
								<div class="themes-dropdown">
									<div class="dropdown">
										<a class="btn dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Premium Themes</a>
								...
								<div class="option-swticher-body">
									...
									<div class="no-col-space header-opns">
										<a href="javascript:void(0);" class="btn-u scrollUp-header">Scroll</a>
...
var setColor = function (color) {
	...
	jQuery('.fixed-header').click(function(){
		'use strict';
		jQuery(this).addClass('active-switcher-btn');
		jQuery('.static-header, .scrollUp-header').removeClass('active-switcher-btn');
		jQuery('body').removeClass('static up-scroll');
		jQuery('nav').removeClass('navbar-scrollUp').addClass('animated');
	});
	jQuery('.scrollUp-header').click(function(){
		'use strict';
		jQuery(this).addClass('active-switcher-btn');
		jQuery('.fixed-header, .static-header').removeClass('active-switcher-btn');
		jQuery('body').removeClass('static').addClass('up-scroll');
		jQuery('nav').addClass('navbar-scrollUp').removeClass('animated');
	});
	jQuery('.static-header').click(function(){
		'use strict';
		jQuery(this).addClass('active-switcher-btn');
		jQuery('.fixed-header, .scrollUp-header').removeClass('active-switcher-btn');
		jQuery('body').removeClass('up-scroll').addClass('static');
		jQuery('nav').removeClass('navbar-scrollUp navbar-sticky');
	});

if($(window).width() > 750) {
    ...
    <div class="option-switcher animated">
      ...
      <div class="option-swticher-body">
        ...
        <span class="subtitle">Layout style</span>
        <div class="no-col-space">
          <a href="javascript:void(0);" class="btn-u active-switcher-btn wide-layout-btn">Wide</a>
          <a href="javascript:void(0);" class="btn-u boxed-layout-btn">Boxed</a></div>
        <div class="bg-patern">
          <span class="subtitle">Background pattern</span>
        ...
        <div class="no-col-space">
          ...
          <a href="javascript:void(0);" class="btn-u fixed-header">Fixed</a></div>
      </div>
    </div>
  </div>`);
	  $('#body').prepend(link);
...
var setColor = function (color, data_logo) {
	...
	var fixed = jQuery('.fixed-header'); var stat = jQuery('.static-header'); if(jQuery('body').hasClass('static')){ fixed.removeClass('active-switcher-btn'); stat.addClass('active-switcher-btn'); } else { stat.removeClass('active-switcher-btn'); fixed.addClass('active-switcher-btn '); }

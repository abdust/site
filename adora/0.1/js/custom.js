	...
	$(window).on('load', function(){
		...
		function getContent(data) {
		    ...
		    $.each(data, function (i, value) {
		    	...
		    	htmlString += '<a class="dropdown-item" href="'+ value.link +'">'+ value.title +' <span class="badge badge-category">'+ value.category +'</span>';
		    	htmlString += '<div class="project-promo">';
				htmlString += '<img class="img-full" src="'+ value.thumbnail +'" alt="project">';
				htmlString += '</div>';
				htmlString += '</a>';
		    });

...
var setColor = function (color) {
	...
	jQuery('.tho-bg-patern li.pattern-default').click(function () {
		...
		.removeClass('pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');
	});
	jQuery('.tho-bg-patern li.pattern1').click(function () {
		...
		.removeClass('default pattern-02 pattern-03 pattern-04 pattern-05');
	});
	jQuery('.tho-bg-patern li.pattern2').click(function () {
		...
		.removeClass('default pattern-01 pattern-03 pattern-04 pattern-05');
	});
	jQuery('.tho-bg-patern li.pattern3').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-04 pattern-05');
	});
	jQuery('.tho-bg-patern li.pattern4').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-03 pattern-05');
	});
	...
	jQuery('.tho-bg-patern li.pattern6').click(function () {
		...
		.removeClass('default pattern-01 pattern-02 pattern-03 pattern-04 pattern-05');
	});
...
ltr.click(function() {
	...
	jQuery("#option_style").attr("href", "assets/css/star.css");
...
rtl.click(function() {
  ...
  jQuery("#option_style").attr("href", "assets/css/star.rtl.css");
});